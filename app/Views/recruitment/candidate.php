...
<div class="modal fade" id="interview_modal" tabindex="-1" aria-labelledby="interview_modalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header modal-custom-purple">
                <h5 class="modal-title" id="interview_modalLabel">
            ...
            <form id="form_interview">
                <div class="modal-body">
                    <input type="hidden" id="interview_id" name="candidate_id">
                    <div class="row g-2">
                        <div class="col-md-12">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="row g-2">
                                        <div class="col-md-12">
                                            <label for="interview_candidate_name" class="form-label">Candidate</label>
                                            <input type="text" class="form-control" id="interview_candidate_name" name="candidate_name" readonly>

                                        </div>

                                        <div class="col-md-12">
                                            <label for="interview_interviewer" class="form-label">Interviewer</label>
                                            <select class="form-select" id="interview_interviewer" name="interviewer" required>

                                            </select>
                                        </div>

                                        <div class="col-md-12">
                                            <label for="interview_interview_date" class="form-label">Interview Date & Time</label>
                                            <input type="datetime-local" class="form-control" id="interview_interview_date" name="interview_date" required>
                            ...
                            <div class="card-body">
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="datetime-local" class="form-control" id="view_interview_date" readonly>
...
<style>
    #interview_modal .select2-container--default .select2-selection--single {
        height: calc(1.5em + 0.75rem + 2px);
    }

    #interview_modal .select2-container--default .select2-selection--single .select2-selection__rendered {
        line-height: calc(1.5em + 0.75rem);
    }

    #interview_modal .select2-container--default .select2-selection--single .select2-selection__arrow {
        height: calc(1.5em + 0.75rem + 2px);
    }
</style>
<?= $this->endSection() ?>
...
<script>
    ...
    $('#interview_modal').on('shown.bs.modal', function() {
        initSelect2Ajax('#interview_interviewer', 'Select Interviewer', "<?= base_url('select_form/employeeSelect') ?>", '#interview_modal .modal-body');
    });
    ...
    $('#interview_modal').on('hidden.bs.modal', function() {
        $(this).find('form')[0].reset();
        $(this).find('select').val(null).trigger('change');
        $(this).find('.error, .invalid-feedback').remove();
        $(this).find('.is-invalid').removeClass('is-invalid');
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.interview-btn', function() {
            $('#interview_id').val($(this).data('id'));
            $('#interview_candidate_name').val($(this).data('candidate_name'));
