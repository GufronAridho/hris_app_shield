            ...
            <div class="card shadow-sm rounded-3 custom-card-purple card-table">
                ...
                <div class="card-body p-4">
                    <table class="table table-bordered table-striped table-hover table-custom" id="table_detail">
                        <thead>
                            <tr>
                                <th class="text-center" style="width:90%;">Status</th>
                        ...
                        <div class="card w-100">
                            ...
                            <div class="card-body">
                                <div class="col-md-7">
                                    ...
                                    <input type="text" class="form-control" id="add_status" name="status" required>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url: "<?= base_url('master_data/delete_status') ?>",
                        type: "POST",
                        data: {
                            id: id
                        },
    ...
    function get_table() {
        ...
        `);
        $.ajax({
            url: "<?= base_url('master_data/status_table'); ?>",
            type: "GET",
            dataType: "html",
    ...
    $("#form_add").on("submit", function(e) {
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                return $.ajax({
                    url: "<?= base_url('master_data/create_status') ?>",
                    type: "POST",
                    data: dataForm,
                    processData: false,
                    contentType: false,
    ...
    $("#form_edit").on("submit", function(e) {
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                return $.ajax({
                    url: "<?= base_url('master_data/update_status') ?>",
                    type: "POST",
                    data: dataForm,
                    processData: false,
                    contentType: false,
