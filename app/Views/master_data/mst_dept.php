...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url: "<?= base_url('master_data/delete_dept') ?>",
                        type: "POST",
                        data: {
                            id: id
                        },
    ...
    $("#form_add").on("submit", function(e) {
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                return $.ajax({
                    url: "<?= base_url('master_data/create_dept') ?>",
                    type: "POST",
                    data: dataForm,
                    processData: false,
                    contentType: false,
    ...
    $("#form_edit").on("submit", function(e) {
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                return $.ajax({
                    url: "<?= base_url('master_data/update_dept') ?>",
                    type: "POST",
                    data: dataForm,
                    processData: false,
                    contentType: false,
