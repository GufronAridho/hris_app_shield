        ...
        <div class="card shadow-lg d-flex flex-column flex-md-row custom-card">
            ...
            <div class="col-12 col-md-7 p-3 form-section d-flex flex-column justify-content-center">
                <div class="text-center mb-3">
                    <h3 class="fw-bold text-dark">Check-Out</h3>
                    <p class="">Enter your Employee ID to record attendance</p>
                </div>

                <form method="post" action="<?= base_url('attendance/emp_check_out'); ?>" autocomplete="off">
                    <?= csrf_field() ?>
                    ...
                    <div class="d-grid col-12 col-md-8 mx-auto">
                        <button type="submit" class="btn btn-primary btn-block">
                            <i class="fa fa-sign-in-alt me-2"></i> Check Out
                        </button>
                    </div>
                </form>
            </div>
